...
async function addData(e) {
    ...
    try {
        const response = await axios.post("https://crudcrud.com/api/09249a3661b14fbcbcc784fe8c2e866e/callBookings", details);
...
async function getData() {
    try {
        const response = await axios.get("https://crudcrud.com/api/09249a3661b14fbcbcc784fe8c2e866e/callBookings");
...
async function deleteDataFromBackend(userId) {
    try {
        const res = await axios.delete(`https://crudcrud.com/api/09249a3661b14fbcbcc784fe8c2e866e/callBookings/${userId}`);
    } catch (err) {
        console.log(err);
    }
}
...
async function editUserItemFromBackend(userId){
    try{
        const res = await axios.put(`https://crudcrud.com/api/09249a3661b14fbcbcc784fe8c2e866e/callBookings/${userId}`);
    }catch(err){
        console.log(err)
    }
}
